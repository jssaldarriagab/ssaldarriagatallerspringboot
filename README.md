...
Al acceder a las rutas proporcionadas en la seccion anterior, se encontrará la interfaz interactiva de Swagger UI. Desde alli se podra ver todos los controladores detectados por Spring Boot y probar cada uno de los endpoints de manera grafica y en tiempo real.
